...
-- [North Pacific Ocean]
insert into nationtb(en_name, ko_name, dust, continents, speech, price, s_date, f_date, customer) values('hawaii', '하와이', 1, 2, '오아후섬부터 호놀룰루 시내투어까지, 수상 액티비티도OK!', 213534,'2020-02-05','2020-02-09', 3); 
...
insert into nationtb(en_name, ko_name, dust, continents, speech, price, s_date, f_date, customer) values('fukuoka', '후쿠오카', 2, 4, '일본에서 가장 활기찬 도시 중 하나', 697000,'2020-02-10','2020-02-13', 3);
