...
-- [North Pacific Ocean]
insert into nationtb(name, dust, continents, speech, price) values('hawai', 1, 2, '오아후섬부터 호놀룰루 시내투어까지, 수상 액티비티도OK!', 213534); 

-- [Africa]
insert into nationtb(name, dust, continents, speech, price) values('Dubai', 3, 3, '부르즈 할리파의 125층 전망대', 236556); 
